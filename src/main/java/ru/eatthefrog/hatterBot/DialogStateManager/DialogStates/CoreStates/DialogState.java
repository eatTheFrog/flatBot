...
import ru.eatthefrog.hatterBot.DialogStateManager.DialogStates.SpecificStates.UnknownDialogState;
...
public abstract class DialogState {
    ...
    @Autowired
    public FinalStringProvider finalStringProvider;

    @Autowired
    public UnknownDialogState unknownDialogState;

    @Autowired
    public NotYetImplementedState notYetImplementedState;

    @Autowired
    public LoggedMainMenu loggedMainMenu;

    @Autowired
    public LoginValidChecker loginValidChecker;

    @Autowired
    public UnloggedMainMenu unloggedMainMenu;
